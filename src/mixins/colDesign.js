...
export default {
  ...
  methods: {
    ...
    getCol() {
      ...
      if (this.detailColNameTwo) {
        API.getForm(apiColName, this.detailColNameTwo).then(res => {
          this.columnDetailTwo = res
          this.detailTableShowTwo = true
        })
      }
    },
