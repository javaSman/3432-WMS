  ...
  <div class="page">
    <table cellspacing="0" cellpadding="0" class="table">
      <thead>
        ...
        <tr class="top-title">
          <td colspan="2" style="border-top: none; border-bottom: none">单据类型:{{ data[0]._orderType }}</td>
          <td colspan="2" style="border-top: none; border-bottom: none">制单日期:{{ getDate }}</td>
          <td colspan="3" style="border-top: none; border-bottom: none">回收方:{{ data[0].deptName }}</td>
        ...
        <tr class="td-title">
          ...
          <td colspan="1" style="border-bottom: none !important">收货数量</td>
          <td colspan="1" style="border-bottom: none !important">实称数量</td>
