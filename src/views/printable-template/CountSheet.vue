    ...
    <table cellspacing="0" cellpadding="0" class="table">
      <thead>
        ...
        <tr class="top-title">
          ...
          <td colspan="2" style="border-top: none; border-bottom: none">单据类型:{{ data[0].stocktakingType }}</td>
          <td colspan="2" style="border-top: none; border-bottom: none">仓库:{{ data[0].warehouseID }}</td>
          <td colspan="3" style="border-top: none; border-bottom: none">单号:{{ data[0].stocktakingID }}</td>
        </tr>
        <tr class="td-title">
          ...
          <td colspan="1" style="border-bottom: none !important">批次</td>
