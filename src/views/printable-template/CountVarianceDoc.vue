    ...
    <table cellspacing="0" cellpadding="0" class="table">
      <thead>
        ...
        <tr>
          <td colspan="10" class="main-title">
            ...
            盘点差异单
            <span class="top-right">编号:J-S0303.03 </span>
            <!-- <div ref="qrcode11111" class="qrcodestyle" /> -->
          </td>
        </tr>

        <tr class="top-title">
          <!-- <td colspan="2" style="border-top: none; border-bottom: none">仓库:{{ data[0].warehouseID }}</td> -->
          <td colspan="3" style="border-top: none; border-bottom: none">单据类型:盘点差异</td>
          <td colspan="3" style="border-top: none; border-bottom: none">制单日期:{{ getDate }}</td>
          <td colspan="4" style="border-top: none; border-bottom: none">单号:{{ data[0].skReportID }}</td>
        </tr>
        <tr class="td-title">
          ...
          <td colspan="1" style="border-bottom: none !important">库存数量</td>
          <td colspan="1" style="border-bottom: none !important">实盘数量</td>
          <td colspan="1" style="border-bottom: none !important">盘盈/盘亏</td>
          <td colspan="1" style="border-bottom: none !important">差异数量</td>
      ...
      <tfoot>
        ...
        <tr class="tb-footer">
          ...
          <td colspan="2">第一联:财务</td>
          <td colspan="2">第二联:仓库</td>
          <td colspan="2">第三联:领料部门</td>
          <td colspan="3">第四联:存档</td>
        </tr>
        <tr class="tb-footer1">
...
export default {
  ...
  methods: {
    ...
    //   })
    //   qrcode.makeCode(this.data[0].stocktakingID)
