    ...
    <table cellspacing="0" cellpadding="0" class="table">
      <thead>
        ...
        <tr class="top-title">
          ...
          <td colspan="2" style="border-top: none; border-bottom: none">客户:</td>
          <td colspan="2" style="border-top: none; border-bottom: none">原销售订单</td>
          <td colspan="3" style="border-top: none; border-bottom: none">单号:{{ data[0].shipmentID }}</td>
        </tr>
        <tr class="td-title">
