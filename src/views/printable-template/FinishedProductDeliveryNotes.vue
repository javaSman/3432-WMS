  ...
  <div class="page">
    <table cellspacing="0" cellpadding="0" class="table">
      <thead>
        ...
        <tr>
          <td colspan="8" class="main-title">
            ...
            成品送货单
            <span class="top-right">编号:J-S0303.12</span>
            <div ref="qrcode11111" class="qrcodestyle" />
          </td>
        </tr>

        <tr class="top-title">
          <td colspan="2">制单日期:{{ getDate }}</td>
          <td colspan="3">销售订单:{{ data[0].saleordercode }}</td>
          <td colspan="3" style="border-top: none">单号:{{ data[0].pickID }}</td>
        </tr>
        <tr class="top-title">
          <td colspan="3">客户:</td>
          <td colspan="5">送货地址:</td>
        </tr>
        <tr class="top-title">
          <td colspan="3" style="border-top: none; border-bottom: none">客户联系人:</td>
          <td colspan="5" style="border-top: none; border-bottom: none">客户联系电话:</td>
        </tr>
        <tr class="td-title">
          <td colspan="1" style="border-bottom: none !important">序号</td>
          <td colspan="1" style="border-bottom: none !important">销售订单</td>
          ...
          <td colspan="1" style="border-bottom: none !important">出货数量</td>
          <!-- <td colspan="1" style="border-bottom: none !important">实领数量</td> -->
      ...
      <tfoot>
        ...
        <tr class="tb-footer">
          <td colspan="8">此表一式五联</td>
        </tr>
        <tr class="tb-footer">
          <td colspan="2">第一联:财务</td>
          <td colspan="1">第二联:仓库</td>
          <td colspan="1">第三联:客户</td>
          <td colspan="2">第四联:账务</td>
          <td colspan="2">第五联:存档</td>
        </tr>
        <tr class="tb-footer1">
          <td colspan="8"><span tdata="pageNO">第##页</span>，<span tdata="pageCount">共##页</span></td>
        </tr>
      </tfoot>
    </table>
