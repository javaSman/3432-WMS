    ...
    <table cellspacing="0" cellpadding="0" class="table">
      <thead>
        ...
        <tr class="top-title">
          ...
          <td colspan="2" style="border-top: none; border-bottom: none">供应商:{{ data[0].supplierName }}</td>
          <td colspan="3" style="border-top: none; border-bottom: none">单据类型:{{ data[0]._orderType }}</td>
