  ...
  <div class="page">
    <table cellspacing="0" cellpadding="0" class="table">
      <thead>
        ...
        <tr class="top-title">
          <td colspan="4" style="border: none">制单日期:{{ getDate }}</td>
          <td colspan="4" style="border: none">调入仓库:{{ data[0].inWarehouseCode }}</td>
          <td colspan="4" style="border: none">调出仓库:{{ data[0].outWarehouseCode }}</td>
        </tr>
        <tr class="top-title">
          <td colspan="6" style="border: none">单据类型:{{ thead.applyType }}</td>
          <td colspan="6" style="border: none">单号:{{ thead.pickID }}</td>
        </tr>
        <tr class="td-title">
      ...
      <tfoot>
        ...
        <tr class="tb-footer">
          <td colspan="2">调入:</td>
          <td colspan="3">调入审核:</td>
          <td colspan="2">调出:</td>
          <td colspan="3">调出审核:</td>
          <td colspan="2">财务:</td>
        </tr>
        <tr class="tb-footer1">
          <td colspan="2">此表一式四联</td>
          <td colspan="3">第一联:财务</td>
...
export default {
  ...
  methods: {
    creatQrCode() {
      ...
      qrcode.makeCode(this.data[0].allocationID)
