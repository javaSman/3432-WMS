      ...
      <thead>
        ...
        <tr>
          <td colspan="10" class="main-title" style="border: none !important">
            ...
            出库单
            <span class="top-right">编号:J-S0303.14</span>
        ...
        <tr class="top-title">
          <td colspan="2" style="border: none">单据类型:{{ thead.orderType }}</td>
          <td colspan="1" style="border: none">制单日期:{{ getDate }}</td>
          <td colspan="3" style="border: none">发料车间:{{ thead.applyDeptName }}</td>
          <td colspan="3" style="border: none">单号:{{ thead.orderID }}</td>
        </tr>
        <tr class="td-title">
          <td colspan="1" style="border-bottom: none !important; width: 8%">序号</td>
          <td colspan="1" style="border-bottom: none !important; width: auto">物料编码</td>
          ...
          <td colspan="1" style="border-bottom: none !important; width: 8%">数量</td>
          <td colspan="1" style="border-bottom: none !important; width: 10%">仓库</td>
          ...
          <td colspan="1" style="border-bottom: none !important; width: 14%">备注</td>
        </tr>
      </thead>
      <tbody>
