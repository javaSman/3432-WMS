    ...
    <table cellspacing="0" cellpadding="0" class="table">
      <thead>
        ...
        <tr class="top-title">
          ...
          <td colspan="4" style="border-top: none; border-bottom: none">单据类型：{{ data[0].applyType }}</td>
          <td colspan="4" style="border-top: none; border-bottom: none">单号：{{ data[0].pickID }}</td>
        </tr>
        <!-- <tr class="newTitle">
        ...
        <tr class="td-title">
          ...
          <td colspan="1" style="border-bottom: none !important">领料数量</td>
          ...
          <td colspan="1" style="border-bottom: none !important">档次</td>
      ...
      <tfoot>
        ...
        <tr class="tb-footer1">
          <td colspan="11"><span tdata="pageNO">第##页</span>，<span tdata="pageCount">共##页</span></td>
        </tr>
      </tfoot>
    </table>
