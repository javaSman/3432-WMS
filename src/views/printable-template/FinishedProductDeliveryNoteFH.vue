    ...
    <table cellspacing="0" cellpadding="0" class="table">
      <thead>
        ...
        <tr class="top-title">
          ...
          <td colspan="3" style="border-top: none">单号:{{ data[0].shipmentID }}</td>
        </tr>
        <tr class="top-title">
          <td colspan="2">客户:</td>
          <td colspan="6">送货地址:</td>
        </tr>
        <tr class="top-title">
          <td colspan="2" style="border-top: none; border-bottom: none">客户联系人:</td>
          <td colspan="6" style="border-top: none; border-bottom: none">客户联系电话:</td>
        </tr>
        <tr class="td-title">
...
export default {
  ...
  methods: {
    creatQrCode() {
      ...
      qrcode.makeCode(this.data[0].shipmentID)
