  ...
  <div class="page">
    <table cellspacing="0" cellpadding="0" class="table">
      <thead>
        ...
        <tr class="top-title">
          <td colspan="2" style="border-top: none; border-bottom: none">单据类型:{{ data[0].applyType }}</td>
          <td colspan="2" style="border-top: none; border-bottom: none">制单日期:{{ getDate }}</td>
          <td colspan="3" style="border-top: none; border-bottom: none">退料部门:{{ data[0].applyDeptName }}</td>
          <td colspan="2" style="border-top: none; border-bottom: none">单号:{{ data[0].returnID }}</td>
        </tr>
        <!-- <tr class="newTitle">
        ...
        <tr class="td-title">
          ...
          <td colspan="1" style="border-bottom: none !important">退料数量</td>
          <td colspan="1" style="border-bottom: none !important">仓库</td>
          <td colspan="1" style="border-bottom: none !important">批次号</td>
          <td colspan="1" style="border-bottom: none !important">退料原因</td>
        </tr>
      </thead>
      <tbody>
      ...
      <tfoot>
        ...
        <tr class="tb-footer1">
          <td colspan="9"><span tdata="pageNO">第##页</span>，<span tdata="pageCount">共##页</span></td>
        </tr>
      </tfoot>
    </table>
...
export default {
  ...
  methods: {
    creatQrCode() {
      ...
      qrcode.makeCode(this.data[0].returnID)
