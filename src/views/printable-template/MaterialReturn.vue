  ...
  <div class="page">
    <table cellspacing="0" cellpadding="0" class="table">
      <thead>
        ...
        <tr class="top-title">
          <td colspan="2" style="border-top: none; border-bottom: none">单据类型:{{ data[0].orderTypesss }}</td>
          <td colspan="2" style="border-top: none; border-bottom: none">制单日期:{{ getDate }}</td>
          <td colspan="3" style="border-top: none; border-bottom: none">退料部门:</td>
          <td colspan="2" style="border-top: none; border-bottom: none">单号:{{ data[0].orderID }}</td>
        </tr>
        <!-- <tr class="newTitle">
