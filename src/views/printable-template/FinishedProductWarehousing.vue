  ...
  <div class="page">
    <table cellspacing="0" cellpadding="0" class="table">
      <thead>
        ...
        <tr>
          <td colspan="12" class="main-title">
        ...
        <tr class="top-title">
          ...
          <td colspan="3" style="border-top: none; border-bottom: none">入库部门:</td>
        ...
        <tr class="td-title">
          ...
          <!-- <td colspan="1" style="border-bottom: none !important">等级</td> -->
          <td colspan="1" style="border-bottom: none !important">档次</td>
          <!-- <td colspan="1" style="border-bottom: none !important">生产工单号</td> -->
