export default {
  route: {
    ...
    materialHistory: '物料履历',
    safetyStockAlertReport: '库存安全预警报表',
    stockAgeReport: '库龄报表',
    codingRules: '编码规则',
    operationLog: '操作日志',
    ...
    warehousingEntry: '入库单',
    inStockQualityInspection: '物料重检',
    wharf: '码头管理',
    device: '设备管理',
    logisticsLineAlarm: '设备报警记录',
    ConveyerLineNew: '线体管理',
    regionManagement: '区域管理',
    pointManagement: 'AGV点位管理',
    freezeReport: '冻结报表',
    inventoryReport: '库存报表',
    inWarehouseReport: '入库报表',
    report: '报表管理',
    outinStockReport: '出入库报表',
    returnReport: '退货报表',
    conveyorLine: '输送线',
    userWarehouse: '用户仓库权限',
    shelf: '货架管理',
    scrapInStockChange: '在库报废管理',
    // 盘点管理
    inventoryAdm: '盘点管理',
    // InventoryPlan: '盘点计划',
    ...
    // 非生产管理
    NonproductiveOrder: '非生产管理',
    shipmentorder: '发货单管理',
    reInspectionDocManagement: '重检单管理',
    // 在库重检
    scrapInStock: '在库重检',
    // 出库管理
    outStockAdm: '出库管理',
    outShelves: '下架管理',
    outStockRequest: '出库申请表',
    agvTask: 'AGV任务表',
    outStock: '出库单管理',
    // OutRequest: '出库申请单管理',
    ...
    DeliveryOrder: '送货单管理',
    OutboundOrder: '出库单',
    warehousingApplication: '入库申请单',
    ReturnOrder: '退货单管理',
    PickOrder: '领料单管理',
    AllocationOrder: '转库单管理',
  ...
  button: {
    ...
    confirm: '确定',
    generate: '生成送货单',
    generateQuality: '生成质检单',
    generateReturnOrder: '生成退货单',
    saleOrder: '销售订单变更',
    materiallist: '生成备料单',
    generates: '生成单据',
    splitBarcode: '生成标签',
    DeliveryNotePrint: '送货单打印',
    ReturnNotePrint: '退货单打印',
    PostingPrint: '单据打印',
    labelPrint: '标签打印',
    PrintReceipt: '入库单打印',
    IssueDocPrint: '出库单打印',
    changeRecheckorder: '生成重检单',
    openingImport: '期初导入',
    IssueMaterial: '出库备料',
    SynchronizeMaterial: '同步物料信息',
    SynchronizeWarehouse: '同步仓库信息',
    SynchronizeUser: '同步用户信息',
    CreatevarianceReport: '生成差异报表',
    Examine: '审核',
    OAprint: 'OA审批',
    PrintPick: '领料单打印',
    frozen: '冻结',
    thaw: '解冻',
    inStock: '入库',
    outShelvesBatch: '跨批次下架',
    warehouseCorrespond: '物理仓对应',
    replenishOrderCLose: '关闭叫料计划',
    qualifiedInStock: '合格入库',
    ReceiptLine: '按行入库',
    purchaseReturn: '采购退货',
    cancelInStock: '取消入库过账',
    ERPwarehouseCorrespond: 'ERP对应仓库',
    Enable: '启用',
    Disable: '禁用',
    cancelReceipt: '取消入库',
    HaState: '状态切换'
  ...
  // 对话框标题
  dialogHeader: {
    varianceReport: '差异报表明细',
    reInspectionDocManagementDetil: '重检单明细',
    list: '列表',
    // 系统管理
    user: '用户',
    role: '角色',
    ...
    inWarehouseReport: '入库报表',
    inventoryOrder: '盘点单',
    scrapInStockChange: '在库报废',
    ShipmentOrderDetail: '发货单明细',
    stock: '库存',
    stockReport: '库存报表',
    ...
    NonproductiveOrderDetails: '非生产明细',
    inventoryOrderDetails: '盘点单明细',
    scrapInStockChangeDetails: '库存报废单明细',
    QualityInspectionFormDetails: '质检单明细',
    purchaseorderdetail: '采购订单明细',
    inShelvesOrderDetails: '上架单明细',
    deliveryOrderDetails: '收货单明细',
    PickOrderDetail: '领料单明细',
    AllocationOrderDetail: '转库单明细',
    WasteOrderDetail: '废品出入库明细',
    DeliveryOrderDetail: '送货单明细',
    inStockOrderDetails: '入库单明细',
    ...
    warehousingApplication: '申请单明细',
    productionCompletion: '入库单明细',
    materialReturnApplication: '领料单明细',
    ...
    regionManagement: '区域',
    outinStockReport: '出入库',
    materialRequisition: '领料单',
    salesOutboundReturn: '出库单明细'
    // *****业务****
  },
  // 提示
  notify: {
