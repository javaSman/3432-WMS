...
export const MaterialCrud = {
  // add: 'BaseData.Materials.Create',
  // edit: 'BaseData.Materials.Update'
  // del: 'BaseData.Materials.Delete'
  // download: 'BaseData.Materials',
  // import: 'BaseData.Materials.Create'
}
export const BtnItems = [
  {
    ...
    clickFun: 'toDownload',
    disabled: '',
    permission: 'BaseData.Materials.Export',
    styleType: 'warning',
