...
export const formList = [
  ...
  { type: 'Input', label: '当前工艺s', prop: 'stationCodesNow' },
  { type: 'Input', label: '下工艺s', prop: 'stationCodesNext' },
  ...
  { type: 'Input', label: 'NG数量范围', prop: 'ng_CountRange', min: 0 },
  { type: 'Input', label: '托盘数量', prop: 'boxCount' },
  { type: 'Textarea', label: '报错信息', prop: 'errorInfos' },
  { type: 'Input', label: '检测工艺', prop: 'technology' },
  { type: 'Input', label: '重量', prop: 'weight' },
  { type: 'Input', label: '外观监测结果', prop: 'detection' }
]
...
export const detailCol = [
  { prop: 'line_Enabel', label: '启用', sortAble: true },
  { prop: 'lineName', label: '线体名称', sortAble: true },
  { prop: 'dealWay', label: '处理方式', sortAble: true },
  { prop: 'priority', label: '优先级', sortAble: true },
  { prop: 'lineDeviceID', label: '设备编号', sortAble: true }
]
