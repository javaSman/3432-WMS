export const queryItems = [
  { type: 'Input', label: '单据编号', prop: 'StocktakingID' },
  { type: 'Selects', label: '单据类型', prop: 'StocktakingType', options: [] },
...
export const inventoryFormList = [
  ...
  { type: 'Radio', prop: 'check', radios: [{ label: '盲盘', value: '1' }] }
]
// 盘点单头部数据
export const inventoryHeadList = [
  { type: 'Input', label: '单据编号', prop: 'stocktakingID', disabled: true },
  { type: 'Select', label: '单据状态', prop: 'statusID', disabled: true, options: [] },
  {
    type: 'Select',
    label: '单据类型',
    prop: 'stocktakingType',
...
export const inventoryColumnList = [
  ...
  { prop: 'locationID', label: '货位编号' },
  { prop: 'quantity', label: '原有数量' },
  { prop: 'realQty', label: '盘点数量', type: 'colType/Number', max: 65535, min: 0, precision: 2 },
  // { prop: 'materialStatus', label: '物料状态' },
...
export const InventoryOrderCrud = {
  add: 'WarehouseBusiness.InventoryOrder.Create'
  // del: 'any'
}
...
export const inventoryBtnItems = [
  {
    ...
    clickFun: 'toDel',
    disabled: 'multipe',
    permission: 'WarehouseBusiness.InventoryOrder.Delete',
    styleType: 'danger',
  ...
  },
  {
    ...
    disabled: 'single',
    permission: 'WarehouseBusiness.InventoryOrder.FinishOrder',
    styleType: 'danger',
    icon: 'el-icon-finished'
  },
  {
    ...
    disabled: 'single',
    permission: 'WarehouseBusiness.InventoryOrder.OutShelves',
    styleType: 'danger',
    icon: 'el-icon-finished'
  },
  // {
  ...
  // },
  {
    ...
    disabled: 'single',
    permission: 'WarehouseBusiness.InventoryOrder.Print',
    styleType: 'danger',
    icon: 'el-icon-finished'
  },
  {
    ...
    disabled: 'multipe',
    permission: 'WarehouseBusiness.InventoryOrder.Createvariance',
    styleType: 'danger',
    icon: 'el-icon-finished'
  }
]
...
export const varianceReportItems = [
  ...
  { type: 'Input', label: '盘点单号', prop: 'skOrderIDs' }
...
export const varianceBtnItems = [
  {
    ...
    clickFun: 'toPosting',
    disabled: 'single',
    permission: 'WarehouseBusiness.VarianceReport.Posting',
    styleType: 'danger',
    icon: 'el-icon-finished'
  },
  // {
  ...
  // },
  {
    ...
    clickFun: 'toPostingPrint',
    disabled: 'single',
    permission: 'WarehouseBusiness.VarianceReport.Print',
    styleType: 'danger',
    icon: 'el-icon-finished'
  }
]
