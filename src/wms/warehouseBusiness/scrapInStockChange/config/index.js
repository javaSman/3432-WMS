export const queryItems = [
  ...
  { type: 'Selects', label: '单据类型', prop: 'ScrapType', options: [] }
...
export const InventoryOrderCrud = {
  add: 'WarehouseBusiness.ScrapInStockChange.Create',
  del: 'WarehouseBusiness.ScrapInStockChange.Delete'
}
...
export const inventoryBtnItems = [
  ...
  // },
  {
    ...
    clickFun: 'toPosting',
    disabled: 'single',
    permission: 'WarehouseBusiness.ScrapInStockChange.Posting',
    styleType: 'danger',
    icon: 'el-icon-finished'
  },
  {
    ...
    disabled: 'single',
    permission: 'WarehouseBusiness.ScrapInStockChange.Print',
    styleType: 'danger',
    icon: 'el-icon-finished'
  }
]
