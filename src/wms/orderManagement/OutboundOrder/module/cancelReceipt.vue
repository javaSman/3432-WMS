<template>
  <div>
    <div class="head-container">
      <filter-container :form-items="CancelItems" :list-query.sync="listQuery" @query="getList" @reset="reset" />
    </div>
    ...
    <div class="content-container" style="margin-top: 10px">
      ...
      />
      <CrudOperation :button-items="OtherDetailBtn" @toOffShelf="handleOffShelf()" />
    ...
    <div v-if="printBegin" id="outboundOrder" ref="outboundOrder" style="display: none">
      <OutboundOrder :data="outboundOrder" :thead="multipleSelection[0]" :page="salesOutbound.length" />
    </div>
  </div>
</template>
<script>
