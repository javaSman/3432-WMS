<template>
  <div class="components-container">
    <div class="head-container">
      <filter-container :form-items="ProdItems" :list-query.sync="listQuery" @query="getList" @reset="reset" />
    </div>
...
import { ProdItems, Crud } from '../config'
export default {
  ...
  data() {
    return {
      colName: 'FinishedStockOrder',
      detailColName: 'FinishedStockOrderDetail',
