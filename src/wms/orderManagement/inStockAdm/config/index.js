...
export const ReportsCrud = {
  download: 'OrderManagement.InShelves.Export'
}
// 收货管理
...
export const inStockCrud = {
  add: 'OrderManagement.InShelves.Create',
  edit: 'OrderManagement.InShelves.Update',
  del: 'OrderManagement.InShelves.Delete'
}
